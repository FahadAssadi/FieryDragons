...
/**
 * The MovePlayerCommand class represents a command to move a player on the game board.
...
public class MovePlayerCommand extends DragonCardCommand{
    ...
    /**
     * Executes the move player command by moving the player on the game board.
     *
