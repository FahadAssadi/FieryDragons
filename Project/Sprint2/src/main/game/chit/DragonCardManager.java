...
/**
 * The DragonCardManager class manages dragon cards in the main.game.
...
public class DragonCardManager implements EventListener {
        ...
        for (Creature creature : creatures) {
            ...
            for (int j = 0; j < creatureTimes; j++) {
                ...
                for (int k = 1; k <= creatureQuantity; k++) {
                    ...
                    ImageIcon dragonCardImage = new ImageIcon(getClass().getResource(dragonCardImagePath));
    ...
    /**
     * Updates the dragon card manager in response to main.game events.
